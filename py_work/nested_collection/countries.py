...
def all_counries_names():

    return[c.get("name") for c in countries]

# print(all_counries_names())


def get_contry_by_name(counrty_name):

    return[c for c in countries if c.get("name").lower()==counrty_name]

print(get_contry_by_name("china"))

# create a function get_country_capital(country_name)

def get_country_capital(country_name):

    return[c.get("capital") for c in countries if c.get("name").lower()==country_name]

print(get_country_capital("canada"))
...
print(get_contry_by_name("india"))